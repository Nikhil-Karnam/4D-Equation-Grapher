...
public class yVal {
    ...
    //3rd calculate method
    
    public static double calculateY(double x, double y, double z, String f)
    {    	    	
    	//first formats the function
    	f = Simplify.balanceBrackets(f);
    	f = Simplify.multiply(f);
    	...
    	if(operatorTest(f, "+"))
		{
			...
			result += calculateY(x, y, z, f1) + calculateY(x, y, z, f2);
		}
    		
    	//negation (subtraction as first symbol)
   		else if(operatorTest(f, "-") && operatorLocation(f, "-") == 0)
		{
			result -= calculateY(x, y, z, f.substring(1));
		}
		...
		else if(operatorTest(f, "^")) 
		{
			...
			if(calculateY(x, y, z, f1) < 0) 
			{
				if(powerCheck(f2) == 1)//rotational symmetry
				{
					result -= Math.pow(-1 * calculateY(x, y, z, f1), calculateY(x, y, z, f2));
				}
				else if(powerCheck(f2) == 2)//reflect across y axis
				{
					result += Math.pow(-1 * calculateY(x, y, z, f1), calculateY(x, y, z, f2));
				...
				{
					result += Math.pow(calculateY(x, y, z, f1), calculateY(x, y, z, f2));
				}
			}
			else
			{
		...
		else if(operatorTest(f, "arcsin")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.asin(calculateY(x, y, z, inside));
		}
    	//arc cosine
		else if(operatorTest(f, "arccos")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.acos(calculateY(x, y, z, inside));
		}
    	//arc tan
		else if(operatorTest(f, "arctan")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.atan(calculateY(x, y, z, inside));
		}
		...
		else if(operatorTest(f, "sin")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.sin(calculateY(x, y, z, inside));
		}
    	//cos
		else if(operatorTest(f, "cos")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.cos(calculateY(x, y, z, inside));
		}
    	//tan
		else if(operatorTest(f, "tan")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.tan(calculateY(x, y, z, inside));
		}
		...
		else if(operatorTest(f, "csc")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += 1 / Math.sin(calculateY(x, y, z, inside));
		}
    	//sec
		else if(operatorTest(f, "sec")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += 1 / Math.cos(calculateY(x, y, z, inside));
		}
    	//cot
		else if(operatorTest(f, "cot")) 
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += 1 / Math.tan(calculateY(x, y, z, inside));
		}
		...
		else if(operatorTest(f, "ln"))
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.log(calculateY(x, y, z, inside));
		}
		...
		else if(operatorTest(f, "log"))
		{
			...
			String inside = f.substring(location, Simplify.matchingBracket(f, location)+1);
			result += Math.log10(calculateY(x, y, z, inside));
		}
